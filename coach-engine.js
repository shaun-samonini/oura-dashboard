...
const WORKOUT_LIBRARY = {
    ...
    upper_strength: {
        ...
        variants: {
            easy: {
                duration: 25,
                description: '25-min light upper body',
                warmup: [
                    { name: 'Arm circles', duration: '30s each direction' },
                ...
                exercises: [
                    ...
                    { name: 'Overhead press (DB)', sets: 2, reps: '8-10', rest: '60s' },
                    { name: 'Bicep curls', sets: 2, reps: 12, rest: '45s' },
                ],
                cooldown: [
                    { name: 'Chest doorway stretch', duration: '30s each side' },
                    { name: 'Cross-body shoulder stretch', duration: '30s each' },
                ],
            },
            moderate: {
                duration: 35,
                description: '35-min upper body strength',
                warmup: [
                    { name: 'Arm circles', duration: '30s each direction' },
                    { name: 'Band pull-aparts', reps: 20 },
                    { name: 'Light push-ups', reps: 10 },
                ],
                exercises: [
                    { name: 'Push-ups', sets: 4, reps: '12-15', rest: '60s' },
                    { name: 'Dumbbell rows', sets: 4, reps: '10-12 each', rest: '60s' },
                    { name: 'Overhead press (DB)', sets: 3, reps: '10-12', rest: '60s' },
                ...
                cooldown: [
                    { name: 'Chest doorway stretch', duration: '30s each side' },
                    { name: 'Cross-body shoulder stretch', duration: '30s each' },
                    { name: 'Tricep overhead stretch', duration: '30s each' },
                ],
            },
            hard: {
                duration: 45,
                description: '45-min upper body — push the limits',
                warmup: [
                    { name: 'Arm circles', duration: '30s each direction' },
                    { name: 'Band pull-aparts', reps: 20 },
                    { name: 'Push-ups', reps: 15 },
                    { name: 'Light DB press', reps: 10 },
                ],
                exercises: [
                    { name: 'Push-ups (weighted or elevated feet)', sets: 4, reps: '15-20', rest: '60s' },
                    { name: 'Dumbbell rows (heavy)', sets: 4, reps: '8-10 each', rest: '75s' },
                    { name: 'Overhead press (DB)', sets: 4, reps: '10-12', rest: '60s' },
                    { name: 'Superset: Lateral raises + Front raises', sets: 3, reps: '12 each', rest: '45s' },
                    { name: 'Superset: Curls + Skull crushers', sets: 3, reps: '12 each', rest: '45s' },
                    { name: 'Diamond push-ups', sets: 3, reps: '10-12', rest: '45s' },
                    { name: 'Face pulls (band)', sets: 3, reps: 15, rest: '30s' },
                ],
                cooldown: [
                    { name: 'Full upper body stretch', duration: '5 min' },
                ],
            },
        },
    },
    ...
    lower_strength: {
        ...
        variants: {
            easy: {
                duration: 25,
                description: '25-min light lower body',
                warmup: [
                    { name: 'Bodyweight squats', reps: 10 },
                ...
                exercises: [
                    ...
                    { name: 'Walking lunges', sets: 2, reps: '10 each', rest: '60s' },
            ...
            moderate: {
                duration: 35,
                description: '35-min lower body strength',
                warmup: [
                    { name: 'Bodyweight squats', reps: 15 },
                    { name: 'Leg swings (front/back + lateral)', reps: '10 each direction' },
                    { name: 'Glute bridges', reps: 10 },
                ],
                exercises: [
                    { name: 'Goblet squats (heavy DB)', sets: 4, reps: 12, rest: '60s' },
                    { name: 'Romanian deadlift (DB)', sets: 4, reps: 10, rest: '60s' },
                    { name: 'Bulgarian split squat', sets: 3, reps: '10 each', rest: '60s' },
                    { name: 'Hip thrust (weighted)', sets: 3, reps: 12, rest: '60s' },
                    { name: 'Lateral lunges', sets: 3, reps: '10 each', rest: '45s' },
                    { name: 'Calf raises (single leg)', sets: 3, reps: '12 each', rest: '30s' },
                ],
                cooldown: [
                    { name: 'Pigeon pose', duration: '1 min each' },
                    { name: 'Hamstring stretch', duration: '30s each' },
                    { name: 'Quad stretch', duration: '30s each' },
                ],
            },
            hard: {
                duration: 45,
                description: '45-min lower body — go heavy',
                warmup: [
                    { name: 'Bodyweight squats', reps: 15 },
                    { name: 'Inchworm', reps: 5 },
                ...
                exercises: [
                    { name: 'Goblet squats (heaviest DB)', sets: 4, reps: '10-12', rest: '75s' },
                    { name: 'Romanian deadlift (heavy DB)', sets: 4, reps: '8-10', rest: '75s' },
                    { name: 'Bulgarian split squat (DB)', sets: 4, reps: '10 each', rest: '60s' },
                    { name: 'Superset: Hip thrust + Jump squats', sets: 3, reps: '12 / 8', rest: '60s' },
                    { name: 'Walking lunges (DB)', sets: 3, reps: '12 each', rest: '60s' },
                    { name: 'Single-leg calf raise', sets: 3, reps: '15 each', rest: '30s' },
                    { name: 'Wall sit', sets: 2, reps: '45s hold', rest: '45s' },
                ],
                cooldown: [
                    { name: 'Full lower body stretch', duration: '5 min' },
                ],
    ...
    full_body_strength: {
        ...
        variants: {
            easy: {
                duration: 30,
                description: '30-min full body basics',
                warmup: [
                    { name: 'Jumping jacks', reps: 20 },
                    { name: 'Arm circles + leg swings', duration: '2 min' },
                ],
                exercises: [
            ...
            moderate: {
                duration: 40,
                description: '40-min full body circuit',
                warmup: [
            ...
            hard: {
                duration: 50,
                description: '50-min full body blast',
                warmup: [
                    { name: 'Jump rope or jumping jacks', duration: '2 min' },
                    { name: 'Dynamic stretching', duration: '3 min' },
                ],
                exercises: [
                    { name: 'Superset: Push-ups + Goblet squats', sets: 4, reps: '15 / 12', rest: '60s' },
                    { name: 'Superset: DB rows + Romanian DL', sets: 4, reps: '10 each / 10', rest: '60s' },
                    { name: 'Superset: Overhead press + Lunges', sets: 3, reps: '10 / 10 each', rest: '60s' },
                    { name: 'Superset: Curls + Skull crushers', sets: 3, reps: 12, rest: '45s' },
                    { name: 'Core circuit: Plank 45s → Dead bug 10ea → Mountain climbers 15ea', sets: 2, rest: '60s' },
                ],
                cooldown: [
                    { name: 'Full body stretch', duration: '5 min' },
                ],
